...
{
    public class WordMatchingTrainViewModel : BindableBase, INavigationAware
    {
        public WordMatchingTrainViewModel(IDialogHostService dialogService, IRegionManager regionManager) 
        {
        ...
        private void Replay()
        {
            ...
            synthesizer.SpeakAsync("请选择符合文字描述的图片");
        }
